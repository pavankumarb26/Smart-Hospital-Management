...
export default function HospitalCard({ hospital }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-gray-500 mb-1 capitalize">{hospital.type} Hospital</p>
      {hospital.distance != null && (
        <p className="text-sm text-blue-600 font-medium mb-3">{hospital.distance} km away</p>
      )}
